...
{/* TODO: Replace this with a Repsolite JavaDoc URL generator. */}

You should refer to Yet Another Config Lib's [JavaDoc](https://github.com/isXander/YetAnotherConfigLib/tree/294798b2c1b7e6443f717650443d1d171c796943/src/main/java/dev/isxander/yacl3/config/v2/api/autogen) for a full breakdown on what each annotation does.
